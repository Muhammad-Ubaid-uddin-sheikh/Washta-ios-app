...
// import { View, Text, StyleSheet, ScrollView, ActivityIndicator, KeyboardAvoidingView, Alert, Platform, PermissionsAndroid, BackHandler } from 'react-native';
...
//                     showLocationAlert(); // If permission is denied, show an alert and go back
//                     return;
//                 }
//             }
//             getCurrentLocation();
...
//                 showLocationAlert(); // Show alert and navigate back if location is off
//             },
...
//             [
//                 { text: "OK", onPress: () => navigation.goBack() } // Navigate back if location is not enabled
//             ],
//             { cancelable: false }
//         );
//     };
