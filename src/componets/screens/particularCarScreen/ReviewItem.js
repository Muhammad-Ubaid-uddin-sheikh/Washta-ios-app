...
// import MaterialIcons from 'react-native-vector-icons/MaterialIcons'; // Import for delete icon
// import { Fonts, FontsGeneral } from '../style';

// const ReviewItem = ({ user, rating, reviewText, showDelete, onDelete }) => {
//   return (
...
//   starsContainer: {
//     flexDirection: 'row',
//     marginRight: 10, // Space between stars and delete button
//   },
//   reviewText: {
//     fontSize: 13,
//     color: '#888d90',
